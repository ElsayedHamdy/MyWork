...
{
    public partial class AddNewMaterial : UserControl,ISaveBooks,ISaveLectures,ISaveSections
    {
        IExitAddNewMaterial exit;
        AddNewBooks2 book;
        ...
        public AddNewMaterial(IExitAddNewMaterial caller)
        {
            InitializeComponent();
        ...
        private void Donebtn_Click(object sender, EventArgs e)
        {
            if (validate())
            {
                ...
                foreach (var item in Connector.connections)
                {
                    ...
                    {
                        item.CreateMaterials(material);
                    }
                }
                exit.ExitAddNewMaterial(material);
                ParentChanged -= AddNewMaterial_ParentChanged;
                this.Dispose(true);
            }
        }
        ...
        private void AddNewMaterial_ParentChanged(object sender, EventArgs e)
        {
            if (Parent.Size != Size)
            {
