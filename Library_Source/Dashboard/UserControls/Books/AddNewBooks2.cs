...
{
    public partial class AddNewBooks2 : UserControl
    {
        private ISaveBooks callingcontrol;
        List<string> selectedauthors;
        public AddNewBooks2(ISaveBooks caller)
        {
            InitializeComponent();
        ...
        private void Donebtn_Click(object sender, EventArgs e)
        {
             if(validate())
            {
                ...
                ParentChanged -= AddNewBooks2_ParentChanged;
                this.Dispose(true);
            }
        }
        bool validate()
        ...
        private void AddNewBooks2_ParentChanged(object sender, EventArgs e)
        {
            if (Parent.Size != Size)
            {
